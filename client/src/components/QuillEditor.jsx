...
import { useNavigate } from 'react-router-dom';
import Axios from 'axios';
import './../Quilleditor.css'; // Import the CSS file
...
const QuillEditor = () => {
    ...
    return (
        <div className="quill-editor-container">
            ...
            <input type="text" id="recipeName" placeholder="Name of your Recipe" />
            <ReactQuill theme="snow" value={value} onChange={setValue} modules={modules} placeholder="Instructions for your Recipe" />
            <input type="file" id="recipeThumbnailImage" onChange={uploadImage} accept="image/*" />
            <div className="ingredients-input">
                <input type="text" id="ingredients" placeholder="Add an ingredient" />
                <button type="button" onClick={addIngredients}>Add Ingredient</button>
            </div>
